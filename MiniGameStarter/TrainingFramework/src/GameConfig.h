...
#define KEY_LEFT			0x01 << 1
#define KEY_RIGHT			0x01 << 2
#define KEY_UP				0x01 << 3
#define KEY_DOWN			0x01 << 4
#define KEY_MOVE_LEFT		0x01 << 5
#define KEY_MOVE_RIGHT		0x01 << 6
#define KEY_MOVE_FORWARD	0x01 << 7
#define KEY_MOVE_BACKWARD	0x01 << 8
